...
def main(model_title, 
    ...
    #get_archive.create_archive("/home/basay3/Desktop/lira_validation/", "lira/lira1/data/experimental_images.h5", rgb=True)
    ...
    Create our necessary .h5 files since there isn't a write option I can specify to do so with h5py
    """
    #open(resized_img_archive_dir,"w").close()
    #object_detection_editor.edit_detected_objects(rect_h=640, rect_w=640, step_h=320, step_w=320, resize_factor=0.1, img_archive_dir=img_archive_dir, resized_img_archive_dir=resized_img_archive_dir, rects_archive_dir=rects_archive_dir, dual_monitor=True, images_already_resized=False)
